...
export default class Pet {
  ...
  setTelefone(telefone) {
    if(!Pet.validarTelefone(telefone))
  ...
  static assign(obj) {
    return new Pet(obj.matricula, obj.cpf, obj.nome, obj.email, obj.telefone);
  }
