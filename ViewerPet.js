...
export default class ViewerPet {
...
//------------------------------------------------------------------------//
  ...
  apresentar(pos, qtde, Pet) {    
    ...
    if(Pet == null) {
      ...
      this.divAviso.innerHTML = " Número de Pets: 0";
    } else {
      this.tfMatricula.value = Pet.getMatricula();
      this.tfCpf.value       = Pet.getCpf();
      this.tfNome.value      = Pet.getNome();
      this.tfEmail.value     = Pet.getEmail();
      this.tfTelefone.value  = Pet.getTelefone();
      this.divAviso.innerHTML = "Posição: " + pos + " | Número de Pets: " + qtde;
    }
  }
